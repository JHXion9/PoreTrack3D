...
% 定义文件夹路径
folder_path = 'E:\make_dataset\Madrid_Metropolis\otherimages';
folder_path_pathkp = 'E:\make_dataset\Madrid_Metropolis\keypoints';
save_path ='E:\make_dataset\Madrid_Metropolis\descriptors'

% 获取文件夹中所有文件的信息
files = dir(fullfile(folder_path, '*.jpg'));  % 假设文件夹中包含 .jpg 文件
...
for i = 1:total_files
    ...
    % 提取补丁
    patch = extract_patches(image, kp, 32);
