function matches = sqrt_match_descriptors(descriptors1, descriptors2, max_dist_ratio)
...
% 计算 descriptors1 和 descriptors2 的点积
dot_product = descriptors1 * descriptors2';
% 计算距离
%dists = sqrt(complex(2 * (1 -dot_product)));
dists =  dot_product;
