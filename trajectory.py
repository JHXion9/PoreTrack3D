...
def base_view_tracker(opt, first_frame_base, cam_datadir, mesh_path, tracker_model):
    ...
    # 保存相机坐标系下的点云坐标
    save_keypoint_data(None, all_p3d_cam, None, output_path=f'./out/{opt.people_id}', view='cam')
...
if __name__ == '__main__':
    ...
    first_frame_base = np.array([[1394, 1635.]])
